...
describe("FeatureReferenceOAuthClientsStore", () => {
  let clientsStore: FeatureReferenceOAuthClientsStore;

  beforeEach(() => {
    const mockRedis = new MockRedisClient();
    setRedisClient(mockRedis);
    jest.resetAllMocks();
    clientsStore = new FeatureReferenceOAuthClientsStore();
  });
...
describe("FeatureReferenceAuthProvider", () => {
  let provider: FeatureReferenceAuthProvider;
  ...
  beforeEach(() => {
    ...
    provider = new FeatureReferenceAuthProvider();
  });
